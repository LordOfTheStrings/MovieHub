 ...
 <!-- Banner-->
    <div class="banner_2">
        <div class="banner_contents">
            <h1 class="banner_title">Harry Potter</h1>
            <div class="banner_buttons">
                <a href="player.php?movie=HarryPotter" class="banner_button" role="button">Watch</a>
            </div>
            <div class="banner_description">
            The main story concerns Harry's struggle against Voldemort, who intends to become immortal, overthrow the Ministry of Magic and subjugate all wizards and Muggles.
            </div>
        </div>
